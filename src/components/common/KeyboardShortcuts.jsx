  ...
  const shortcuts = [
    {
      ...
      items: [
        ...
        { keys: ['2'], description: 'Consensus tab' },
        { keys: ['3'], description: 'Distributions tab' },
        { keys: ['4'], description: 'Correlation tab' },
        { keys: ['5'], description: 'Simulation tab' },
        { keys: ['6'], description: 'Factors tab' },
        { keys: ['7'], description: 'Optimize tab' },
        { keys: ['8'], description: 'Export tab' },
      ],
    },
    {
      ...
      items: [
        ...
        { keys: ['3', '→', 'Enter'], description: 'Distributions: Estimate from History' },
        { keys: ['4', '→', 'Enter'], description: 'Correlation: Estimate from History' },
        { keys: ['5', '→', 'Enter'], description: 'Simulation: Run Monte Carlo' },
        { keys: ['6', '→', 'Enter'], description: 'Factors: Run Factor Analysis' },
        { keys: ['7', '→', 'Enter'], description: 'Optimize: Run Optimization' },
      ],
    },
    {
